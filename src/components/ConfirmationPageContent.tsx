    ...
    return (
        <Card className="max-w-md mx-auto">
            <CardHeader className="items-center text-center">
                ...
                <CardTitle className="text-2xl font-headline">Booking ID Missing</CardTitle>
                <CardDescription>We couldn't find your booking details. Please try booking again.</CardDescription>
            </CardHeader>
            <CardFooter>
  ...
  return (
    <Card className="max-w-md mx-auto">
      <CardHeader className="items-center text-center">
        ...
        <CardDescription>Our technician will call you within 30 minutes.</CardDescription>
      </CardHeader>
