      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8 md:mb-12">
          <motion.h2
            ...
            className="text-xl md:text-2xl font-black tracking-tight text-[#1e1b4b]"
          >
        ...
        <div className="flex justify-between items-center mb-8 relative px-2 md:px-8">
          {/* Connecting Line Backdrop */}
          <div className="absolute top-1/2 left-0 right-0 h-0.5 md:h-1 bg-indigo-100 -translate-y-1/2 -z-10 rounded-full" />
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Step Label */}
                <div className={cn(
                  "absolute -bottom-6 left-1/2 -translate-x-1/2 text-[9px] md:text-[10px] font-bold uppercase tracking-tight transition-opacity whitespace-nowrap",
        ...
        {/* Active View Area */}
        <div className="relative min-h-[340px] md:min-h-[280px] flex flex-col items-center">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="w-full bg-gradient-to-br from-indigo-50/50 to-indigo-100/30 rounded-2xl md:rounded-3xl p-5 md:p-6 border-2 border-indigo-200 shadow-xl flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-8"
            >
              {/* GIF Container */}
              <div className="relative w-48 h-48 md:w-56 md:h-56 rounded-2xl md:rounded-3xl overflow-hidden bg-white shadow-2xl border-4 border-indigo-100 flex-shrink-0">
                <Image
              ...
              <div className="text-center md:text-left flex-1 flex flex-col justify-center">
                <h3 className="font-bold text-lg md:text-2xl mb-2 uppercase tracking-tight text-indigo-900">
                  {steps[activeStep].title}
                </h3>
                <p className="text-indigo-600 text-xs md:text-sm font-medium leading-relaxed">
                ...
                {steps.map((_, i) => (
                  <button
                    ...
                    className={cn(
                      ...
                      activeStep === i ? "w-8 bg-indigo-600" : "w-1.5 bg-indigo-200"
                    )}
                  />
                ))}
              </div>
